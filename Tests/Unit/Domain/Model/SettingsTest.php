...
/**
 * Test case for class \TYPO3\PitsMailchimp\Domain\Model\Settings.
 *
...
class SettingsTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \TYPO3\PitsMailchimp\Domain\Model\Settings
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \TYPO3\PitsMailchimp\Domain\Model\Settings();
	}
